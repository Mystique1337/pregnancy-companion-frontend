...
export const config = {
  matcher: ["/dashboard/:path*", "/chat/:path*", "/account/:path*", "/journal/:path*", "/tools/:path*", "/appointments/:path*", "/vitals/:path*", "/hospitals/:path*", "/library/:path*", "/report/:path*", "/triage/:path*", "/bump/:path*", "/emergency/:path*"],
};
